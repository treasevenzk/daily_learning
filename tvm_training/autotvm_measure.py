...
# Add the following code to print the solution:
if status == cp_model.OPTIMAL or status == cp_model.FEASIBLE:
    print(f"Status: {solver.StatusName(status)}")
    
    # Print all variable values
    variables = [
        wmma_m, wmma_n, wmma_k, wmma_m_wmma_n,
        dense_i_outer, dense_i_inner, dense_j_outer, dense_j_inner,
        dense_vectorize, B_shared_vectorize, A_shared_vectorize,
        threads, A_shared_shared_mem_size, B_shared_shared_mem_size, 
        dense_wmma_accumulator_shared_shared_mem_size
    ...
    # To print all variables in the model, you can use:
